...
def train_model(model,
    ...
    for epochs in range(0, num_epochs):
        ...
        train_loss, train_accuracy = loss_train, 1 - np.mean(f1_score)  # Placeholder for actual accuracy calculation
        val_loss, val_accuracy = loss_test, test_metrics["AUC"]  # Placeholder for actual accuracy calculation
    ...
    # Plot histograms for loss and accuracy
